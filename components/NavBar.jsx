...
function NavBar() {
  return (
    ...
    <div className="container-fluid">
        <Link href="/">
          <a className="navbar-brand text-white mx-auto display-6" >ONE STONE LIMITED</a>
        </Link>
        ...
        <ul className="navbar-nav me-auto mb-2 mb-lg-0 mx-auto ">
            ...
            <li className="nav-item">
              <Link href="#contact">
                <a className="nav-link text-white" aria-current="page"  >Contact</a>
              </Link>
            </li>
            <li className="nav-item">
              <Link href="#">
                <a className="nav-link text-white" aria-current="page"  >About us</a>
              </Link>
            </li>
